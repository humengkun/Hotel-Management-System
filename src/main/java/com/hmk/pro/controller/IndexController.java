package com.hmk.pro.controller;
...
import com.hmk.pro.po.base.Employee;
import com.hmk.pro.po.power.MFunctioncontrol;
import com.hmk.pro.po.power.MFunctioncontrolExample;
import com.hmk.pro.po.power.MSysFuncsecurity;
import com.hmk.pro.po.power.MSysFuncsecurityExample;
import com.hmk.pro.service.power.FunctionControlService;
import com.hmk.pro.service.power.SysFunctionService;
import com.hmk.pro.util.ValidateImage;
...
//		}
		...
		if(user!=null&&user.getGroupid()!=null) {
			...
			MSysFuncsecurityExample.Criteria funcCriteria=funcrexample.createCriteria();
		...
		MFunctioncontrolExample.Criteria criteria1=example1.createCriteria();
		...
		MFunctioncontrolExample.Criteria criteria=example.createCriteria();
