...
<title>基于JAVA SSM框架的酒店客房管理系统</title>
...
<div class="header">
			<ul>
				<li><img style="margin-top: 12px;" src="<c:url value='/img/head_logo2.png'/>"></li>
				<li ><div style="margin-top:24px;margin-left:5px; width: 2px;height:25px; background: #FFF;"></div></li>
				<li style="margin-top: 10px;">基于JAVA SSM框架的酒店客房管理系统</li>
			</ul>
		</div>
		<style>
			.header{
